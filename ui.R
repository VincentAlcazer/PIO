...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(
      ...
      selectInput("disease", label = "Preloaded datasets",
                  choices = c("ACC", "ALL","AML","BLCA", "BRCA","CESC","CHOL","COAD",
      ...
      radioButtons("analysis_type", label = ("Analysis mode"),
                   choices = c("PIO Optimal"="optimal","PIO Custom"="custom",
                               "Panel Test"="test"),
                   selected = "optimal"
                   ),
      div(style = "margin-top: -20px"),
      radioButtons("mutation_group", "Group mutations by:",
                   choices = c("Exons/introns"="exon_id",
                               "Genes"="gene_id"), selected  = "gene_id"),
      div(style = "margin-top: -20px"),
      radioButtons("metric_type", label = "Informativity metric:",
                   choices = c("Unique patients" = "unique_pts",
                               "Unique patients / kb" = "pts_per_kb"), selected = "unique_pts"),
      div(style = "margin-top: -20px"),
      numericInput("min_pts", label = "Min. patients / mutation", 
                   value = 2, min = 1),
  ...
  dashboardBody(
    fluidPage(
      useShinyjs(),
        ...
        column(9,
        tabsetPanel(id = "panassis", type = "tabs",
                 tabPanel("Informativity",
                          h3("Methods"),
                          column(12,
                 ...
                 tabPanel("Mutations",
                          tabsetPanel(id = "mutations", type = "tabs",
                                      tabPanel("Statistics",
                                               column(12,
                                               ...
                                               column(12,h3("Cumulated mutations"),
                 ...
                 tabPanel("Length analysis",
                          column(12,
                                 ...
                                 numericInput("max_length",label = "Max panel length (kb)",
                                                     min = 1, value = 1000),actionButton("run_length_analysis", "Run length analysis"),
